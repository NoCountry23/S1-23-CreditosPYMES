...
export default function HeaderUserMenu({ user }: { user: SupabaseUser }) {
  ...
  return (
    <div className="relative z-20">
      ...
      {/* User Dropdown */}
      {showUserMenu && (
        <div className="absolute right-0 mt-2 w-fit  rounded-lg shadow-xl border bg-background border-gray-500/50 overflow-hidden">
          ...
          <div className="border-t border-gray-500/50 py-2 px-4">
