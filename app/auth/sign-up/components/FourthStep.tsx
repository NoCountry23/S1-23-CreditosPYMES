...
export default function FourthStep({
  ...
  return (
    <div className='space-y-5'>
      ...
      {/* DNI */}
      <div className='border-2 border-dashed border-gray-500 rounded-lg p-6 hover:border-blue-500 transition-all'>
      ...
      <div className=' border border-blue-200 rounded-lg p-4 mt-6'>
        <label className='flex items-start gap-3 cursor-pointer'>
          <input
            ...
            className='mt-1 rounded border-gray-500 text-blue-600 focus:ring-blue-500'
          />
