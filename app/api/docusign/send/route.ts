...
// import { Prestamo, Pyme } from "@/lib/types/database";
// import { NextRequest, NextResponse } from "next/server";

// // Esta función prepara los datos específicos para DocuSign
// function prepareDocuSignData(prestamo: Prestamo, pyme: Pyme, user: {email: string, name: string}) {
//   return {
//     signerEmail: user.email,
//     signerName: user.name,
//     signerNumber: pyme.phone || "5491112345678", // Ejemplo
//     signerCountryCode: pyme.phone|| "54", // Argentina por defecto
//     // Estos valores se usarán para rellenar el PDF
//     companyData: {
//       cuit: pyme.cuil_cuit || "123456789",
//       amount: `$${prestamo.monto}`,
//       quotes: prestamo.cant_cuo.toString(),
//       company_name: pyme.company_name,
//       representative: pyme.user_id
//      },
//   };
// }
...
//     console.log(
//       "Envelope ID:",
//       result.envelopeId || result.data?.envelopeId || "No disponible",
//     );
//     console.log(
//       "Status:",
//       result.status || result.data?.status || "No disponible",
//     );
//     console.log(
//       "Success:",
//       result.success || result.data?.success || "No disponible",
//     );
