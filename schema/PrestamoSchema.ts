...
export const StatusEnum = z.enum(
  ["PENDIENTE", "APROBADO", "RECHAZADO", "CANCELADO", "PAGADO"] as const,
  {
...
export const PrestamoSchema = z.object({
  ...
  pyme_id: IdSchema.refine((id) => id.length > 0, {
    message: "El ID de la Pyme es obligatorio.",
  }),
  ...
  monto: z
    ...
    .max(10000000, { message: "El monto excede el límite máximo de préstamo." })
    .nullable(), // Regla de negocio
  ...
  purpose: z
    .string()
    .trim()
    .min(10, { message: "El propósito debe ser descriptivo." })
    .max(1000)
    .optional()
    .nullable(),
